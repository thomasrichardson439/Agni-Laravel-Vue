        ...
        <div class="w-full flex flex-col pt-5 p-3 h-full">
            <div class="w-full flex justify-start">
                <div class="flex mx-2 py-px cursor-pointer"
                     ...
                     :key="index"
                >
                    <p class=" uppercase" :class="selectedTab === tab.id ? 'text-brand-500' : 'text-gray-500'">
                        {{tab.name}}</p>
                </div>
            </div>
            <div class="w-full flex flex-col">
                <div class="w-full flex justify-start flex-wrap pb-5 p-2" v-for="tab in filterTabs" :key="tab.id"
